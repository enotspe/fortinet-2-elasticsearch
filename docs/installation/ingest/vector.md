...
We have split Vector config [files](https://github.com/dr4agon123/fortinet-2-elasticsearch/tree/main/vector) by plattaform, so FortiDragon Vector directory should look like:
